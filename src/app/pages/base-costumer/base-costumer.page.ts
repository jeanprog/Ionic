...
export class BaseCostumerPage implements OnInit {
  ...
  /* async submitClient() {
    ...
    const iCodLoja = this.lojaconfig.getParamsLoja().parametros.iCodLoja;
